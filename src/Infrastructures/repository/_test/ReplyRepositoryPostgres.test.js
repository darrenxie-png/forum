...
describe('ReplyRepositoryPostgres', () => {
  ...
  describe('addReply', () => {
    it('should persist reply and return correctly', async () => {
      const mockPool = { query: jest.fn().mockResolvedValue({ rows: [{ id: 'reply-abc123', content: 'A reply', owner: 'user-1' }] }) };
  ...
  describe('getRepliesByCommentId', () => {
    it('should return all replies by comment id', async () => {
      const mockReplies = [{ id: 'reply-1', username: 'user1', date: '2024-01-01', content: 'Reply', is_deleted: false }];
