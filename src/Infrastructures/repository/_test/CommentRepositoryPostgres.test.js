...
describe('CommentRepositoryPostgres', () => {
  ...
  describe('addComment', () => {
    it('should persist comment and return correctly', async () => {
      const mockPool = { query: jest.fn().mockResolvedValue({ rows: [{ id: 'comment-abc123', content: 'A comment', owner: 'user-1' }] }) };
  ...
  describe('getCommentsByThreadId', () => {
    it('should return all comments by thread id', async () => {
      const mockComments = [{ id: 'comment-1', username: 'user1', date: '2024-01-01', content: 'Comment', is_deleted: false }];
